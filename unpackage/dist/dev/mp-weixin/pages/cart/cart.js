...
/* harmony import */ var _cart_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cart.vue?vue&type=style&index=0&lang=css& */ 35);
...
var _goods = _interopRequireDefault(__webpack_require__(/*! ../../static/books/goods.js */ 34));
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 3));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var shopcart = function shopcart() {__webpack_require__.e(/*! require.ensure | components/shopcart */ "components/shopcart").then((function () {return resolve(__webpack_require__(/*! @/components/shopcart.vue */ 58));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var cartcontrol = function cartcontrol() {__webpack_require__.e(/*! require.ensure | components/cartcontrol */ "components/cartcontrol").then((function () {return resolve(__webpack_require__(/*! @/components/cartcontrol.vue */ 65));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =

{
  ...
  onLoad: function onLoad(e) {var _this2 = this;
    ...
    // this.getMenu(1);
    console.log(_goods.default.data().goods);
    this.goods = _goods.default.data().goods;
